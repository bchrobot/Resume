...
\urlstyle{same}\url{https://www.benjaminchrobot.com} % Your website, LinkedIn profile or other web address
}
...
\runsubsection{Weill Cornell Medicine}
\descript{| Software Developer}

\location{November 2017 – Present | New York, NY}
...
\runsubsection{Treble Media, Inc.}
\descript{| Product Manager}

\location{October 2016 – October 2017 | Brooklyn, NY}
\begin{tightitemize}
...
\runsubsection{MIT Interfraternity Council}
\descript{| Independent Contractor}

\location{June 2015 – September 2016 | Cambridge, MA}
\begin{tightitemize}
...
\location{June 2011 – April 2016 | Millbrook, NY \& Sunapee, NH }
\begin{tightitemize}
...
%   % \item Managed day-to-day operations of 4 member rock band including finances
%   % \item Scheduled practice and tour dates
% \end{tightitemize}
...
\runsubsection{BetaNYC}
\descript{| Leadership Committee }

\location{October 2017 – Present | New York, NY}
\begin{tightitemize}
...
% \runsubsection{MIT Discover Product Design}
% \descript{| Program Mentor }

% \location{August 2012 - August 2015 | Cambridge, MA }
% \begin{tightitemize}
...
\runsubsection{ACSC}
\descript{| Cybersecurity Researcher}

\location{September 2016 – January, 2017 | Bedford, MA}
...
% \runsubsection{Civic Tech}
% % \descript{| Appalachian Trail}

% \location{March 2015 – January 2016 | Code for Boston}
% Completed the 2200-mile backpacking trip from Georgia to Maine

% \location{September 2017 – Present | BetaNYC}
