...
\descript{SB in Electrical Engineering \\ and Computer Science}
\location{Expected Dec 2015 | Cambridge, MA}
%Conc. in Software Engineering \\
%College of Engineering \\
\location{ GPA: 4.0 / 5.0 %\\
% Major GPA: 3.94 / 4.0
}
...
Communicating with Mobile Techn \\			% 21W.789
...
\descript{| New Member Advisor \& House Manager}

\location{September 2012 – Present | Cambridge, MA}
\begin{tightitemize}
